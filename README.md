...
The latest version: 5.5.5. Please use `Maven Central` link above to get the client.
...
dependencies {
    ...
    implementation 'com.epam.reportportal:agent-java-junit5:5.5.5'
}
