...
testCompile 'com.epam.reportportal:agent-java-junit5:5.1.0-ALPHA-6'
```
...
dependencies {
    ...
    compile 'com.epam.reportportal:agent-java-junit5:5.1.0-ALPHA-6'
}
