...
The latest version: 5.5.3. Please use `Maven Central` link above to get the client.
...
testImplementation 'com.epam.reportportal:agent-java-junit5:5.5.3'
```
...
dependencies {
    ...
    implementation 'com.epam.reportportal:agent-java-junit5:5.5.3'
}
