...
The latest version: 5.1.11. Please use `Maven Central` link above to get the client.
...
testImplementation 'com.epam.reportportal:agent-java-junit5:5.1.11'
```
...
dependencies {
    ...
    implementation 'com.epam.reportportal:agent-java-junit5:5.1.11'
}
