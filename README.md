...
<dependency>
   ...
   <version>5.1.0-ALPHA-10</version>
</dependency>
```
...
testCompile 'com.epam.reportportal:agent-java-junit5:5.1.0-ALPHA-10'
```
...
dependencies {
    ...
    compile 'com.epam.reportportal:agent-java-junit5:5.1.0-ALPHA-10'
}
