...
The latest version: 5.5.4. Please use `Maven Central` link above to get the client.
...
testImplementation 'com.epam.reportportal:agent-java-junit5:5.5.4'
```
...
dependencies {
    ...
    implementation 'com.epam.reportportal:agent-java-junit5:5.5.4'
}
